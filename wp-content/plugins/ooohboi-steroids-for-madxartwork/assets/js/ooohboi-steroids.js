            ...
            initSwiperElements: function() {
                ...
                if( ! this.$element.children( '.madxartwork-container .swiper-button-next' ).first().length ) {
                    this.$element.children( '.madxartwork-container' ).first().append( 
                        '<div class="swiper-button-next"><svg xmlns="https://www.w3.org/2000/svg" preserveAspectRatio="xMidYMin" viewBox="0 0 27 44"><path d="M27 22L5 44l-2.1-2.1L22.8 22 2.9 2.1 5 0l22 22z"></path></svg></div>' 
                    );
                }
                if( ! this.$element.children( '.madxartwork-container .swiper-button-prev' ).first().length ) {
                    this.$element.children( '.madxartwork-container' ).first().append( 
                        '<div class="swiper-button-prev"><svg xmlns="https://www.w3.org/2000/svg" preserveAspectRatio="xMidYMin" viewBox="0 0 27 44"><path d="M0 22L22 0l2.1 2.1L4.2 22l19.9 19.9L22 44 0 22z"></path></svg></div>' 
                    );
                }
                // pagination
