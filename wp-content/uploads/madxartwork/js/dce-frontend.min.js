...
if($scope.find('.madxartwork-custom-embed-image-overlay').length){$scope.on('mouseup','.madxartwork-custom-embed-image-overlay',function(){if(lightbox){setTimeout(function(){generatePlyrVideo()},1000)}else{setTimeout(function(){generatePlyrVideo()},100)}})}else{generatePlyrVideo()}}};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/video.default',WidgetElements_AdvancedVideoHandler)})})(jQuery)
/*dce-cookie.min.js*/
...
if(madxartworkFrontend.isEditMode()){if($('body > .cursors').length){$('body > .cursors').remove()}}
...
var responsive_cursorTracker=elementSettings.responsive_cursorTracker;var deviceMode=$('body').attr('data-madxartwork-device-mode');if($.inArray(deviceMode,responsive_cursorTracker)>=0){init_cursortracker()}else{cursorTarget.remove()}};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-cursorTracker.default',WidgetElements_CursorTrackerHandler)})})(jQuery)
/*dce-form-step.min.js*/
;function dce_show_step(target,element,direction='next',scroll=!1){var form=jQuery('.madxartwork-element-'+element);var step=jQuery('.madxartwork-element-'+element+' #dce-form-step-'+target);jQuery('.madxartwork-element-'+element+' .madxartwork-error').removeClass('madxartwork-error');jQuery('.madxartwork-element-'+element+' .dce-form-step').hide().addClass('madxartwork-hidden');jQuery('.madxartwork-element-'+element+' .dce-step-active').removeClass('dce-step-active');jQuery('.madxartwork-element-'+element+' .dce-step-active-progressbar').removeClass('dce-step-active-progressbar');jQuery('.madxartwork-element-'+element+' #dce-form-step-'+target+'-progressbar').addClass('dce-step-active-progressbar');jQuery('.madxartwork-element-'+element+' .dce-step-active-summary').removeClass('dce-step-active-summary');jQuery('.madxartwork-element-'+element+' #dce-form-step-'+target+'-summary').addClass('dce-step-active-summary');jQuery('.madxartwork-element-'+element+' #dce-form-step-'+target+'-summary').addClass('dce-step-filled-summary');if(!jQuery('.madxartwork-element-'+element+' .dce-form-step-summary').not('.dce-step-filled-summary').length){jQuery('.madxartwork-element-'+element+' .dce-form-summary-wrapper .madxartwork-button-wrapper').show()}
if(step.hasClass('dce-form-visibility-step')){if((step.hasClass('dce-form-visibility-step-hide-init')&&!step.hasClass('dce-form-visibility-step-hide'))||(step.hasClass('dce-form-visibility-step-show-init')&&!step.hasClass('dce-form-visibility-step-show'))){dce_epro_applyStep(direction,step);console.log('skip step '+target+', direction '+direction);var new_target=step.find('.madxartwork-button-'+direction).attr('data-target');return dce_show_step(new_target,element,direction,scroll)}}
console.log('apply step '+target);dce_epro_applyStep(direction,step);console.log('show step '+target);step.css('display','flex').addClass('dce-step-active');step.removeClass('madxartwork-hidden');if(scroll){console.log('scroll to top');jQuery('html, body').animate({scrollTop:jQuery('.madxartwork-element-'+element).offset().top},500)}
return!0}
...
function dce_validate_step(step){var isValid=!0;step.find('.madxartwork-field-group [required]').each(function(index,el){if(!el.checkValidity()){el.reportValidity();return isValid=!1}});return isValid}
...
;(function($){var WidgetElements_FormHandler=function($scope,$){var elementSettings=get_Dyncontel_ElementSettings($scope);var id_scope=$scope.attr('data-id');var summary=elementSettings.dce_step_summary;if(summary){$scope.find('input, textarea, select').on('change',function(){var custom_id=jQuery(this).attr('name').replace("form_fields[","").replace("[","").replace("]","").replace("]","").replace("[]","");var input_type=jQuery(this).attr('type')?jQuery(this).attr('type'):jQuery(this).prop("tagName");var input_value='';switch(input_type){case 'radio':input_value=jQuery('.madxartwork-element-'+id_scope+' input[id^="form-field-'+custom_id+'-"]:checked').val();break;case 'checkbox':input_value=jQuery('.madxartwork-element-'+id_scope+' input[id^="form-field-'+custom_id+'-"]:checked').map(function(){return jQuery(this).val()}).get();if(input_value){input_value=input_value.join(', ')}
break;case 'select':input_value=jQuery(this).val();input_value=jQuery('.madxartwork-element-'+id_scope+' input[id="form-field-'+custom_id+'"] option:selected"').text()
...
jQuery('.madxartwork-element-'+id_scope+' span[id="dce-summary-value-form-field-'+custom_id+'-'+id_scope+'"]').text(input_value);setTimeout(function(){jQuery('.madxartwork-element-'+id_scope+' .dce-form-step.dce-form-visibility-step').each(function(){var step=jQuery(this);var step_id=step.attr('data-custom_id');var step_summary=jQuery('.madxartwork-element-'+id_scope+' #dce-form-step-'+step_id+'-summary');if(step.hasClass('dce-form-visibility-step-show-init')){if(step.hasClass('dce-form-visibility-step-show')){step_summary.show()}else{step_summary.hide()}}
if(step.hasClass('dce-form-visibility-step-hide-init')){if(step.hasClass('dce-form-visibility-step-hide')){step_summary.hide()}else{step_summary.show()}}});jQuery('.madxartwork-element-'+id_scope+' *[name^="form_fields"]').each(function(){var custom_id=jQuery(this).attr('name').replace("form_fields[","").replace("[","").replace("]","").replace("]","").replace("[]","");if(jQuery(this).prop('disabled')){jQuery('.madxartwork-element-'+id_scope+' #dce-summary-form-field-'+custom_id).hide()}else{jQuery('.madxartwork-element-'+id_scope+' #dce-summary-form-field-'+custom_id).show()}})},100)});$scope.on('click','.dce-form-step-summary-edit',function(){var step_id=jQuery(this).attr('data-target');var element_id=jQuery(this).attr('data-element');dce_show_step(step_id,element_id)});$scope.on('click','.dce-form-summary-wrapper .madxartwork-button-submit',function(){$scope.find('.dce-form-summary-wrapper').slideUp();$scope.find('.madxartwork-field-type-submit button').trigger('click')})}};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/form.default',WidgetElements_FormHandler)})})(jQuery)
/*dce-settings.min.js*/
...
for(var i=0;i<points.length;i++){var p=points[i];dots[i].setAttribute("transform","translate("+p.x+","+p.y+")")}}}};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-svgblob.default',WidgetElements_SvgBlobHandler)})})(jQuery)
...
var is_running=!1;var run=$('#dce-svg-'+id_scope).attr('data-run');if(madxartworkFrontend.isEditMode()){if(tl)tl.kill(feDisp);if(tli)tli.kill(feImage);$('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').off('mouseenter');$('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').off('mouseleave');$('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').off('touchstart');$('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').off('touchend')}
...
is_running=!0;if(run=='paused'&&madxartworkFrontend.isEditMode()){ferma()}else{riproduci()}}
...
var waypointOptions={triggerOnce:!1,continuous:!0};madxartworkFrontend.waypoint($($el),runAnim,waypointOptions)}}
if(elementSettings.svg_trigger=='animation'){createAnimation(random_animation);if(madxartworkFrontend.isEditMode())playShapeEl()}else if(elementSettings.svg_trigger=='rollover'){$('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').on('mouseenter',mouseenterFn);$('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').on('mouseleave',mouseleaveFn);$('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').on('touchstart',mouseenterFn);$('.madxartwork-element[data-id='+id_scope+'] svg, .'+elementSettings.id_svg_class+' a').on('touchend',mouseleaveFn)}else if(elementSettings.svg_trigger=='scroll'){$('#dce-svg-'+id_scope).attr('data-run','paused')
...
var waypointOptions={triggerOnce:!1,continuous:!0};madxartworkFrontend.waypoint($($el),runAnim,waypointOptions)}}
if(madxartworkFrontend.isEditMode()){if(tl)tl.kill(feDisp);$('.madxartwork-element[data-id='+id_scope+'] svg');$('.madxartwork-element[data-id='+id_scope+'] svg');$('.madxartwork-element[data-id='+id_scope+'] svg');$('.madxartwork-element[data-id='+id_scope+'] svg')}};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-filtereffects.default',WidgetElements_SvgFilterEffectsHandler)})})(jQuery)
/*dce-svgmorph.min.js*/
...
var get_data_shape=function(){shapes=[];var ciccio=[];if(madxartworkFrontend.isEditMode()){ciccio=repeaterShape.models}else{ciccio=repeaterShape}
var old_points='';$.each(ciccio,function(i,el){var pippo=[];if(madxartworkFrontend.isEditMode()){pippo=repeaterShape.models[i].attributes}else{pippo=repeaterShape[i]}
...
eval(tweenString);eval(tweenSVG);is_running=!0;if(run=='paused'&&madxartworkFrontend.isEditMode()){ferma()}
...
var waypointOptions={offset:'100%',triggerOnce:!1};madxartworkFrontend.waypoint($($el),runAnim,waypointOptions)}}
...
moveToStep(step)};if(!madxartworkFrontend.isEditMode()&&contentElemsTotal>1&&elementSettings.svg_trigger=='animation'){$('#dce-svg-'+id_scope).attr('data-run','running')}
if(madxartworkFrontend.isEditMode()){if(transitionTl)transitionTl.kill($(dceshape));if(transitionTlpos)transitionTlpos.kill($(dceshape_svg));$('.madxartwork-element[data-id='+id_scope+']').off('mouseenter','svg');$('.madxartwork-element[data-id='+id_scope+']').off('mouseleave','svg');$('.madxartwork-element[data-id='+id_scope+']').off('touchstart','svg');$('.madxartwork-element[data-id='+id_scope+']').off('touchend','svg')}
setTimeout(function(){get_data_anim();get_data_shape();if(elementSettings.svg_trigger=='animation'){createTween();if(madxartworkFrontend.isEditMode()&&contentElemsTotal>1)playShapeEl()}else if(elementSettings.svg_trigger=='rollover'){if(transitionTl)transitionTl.kill($(dceshape));if(transitionTlpos)transitionTlpos.kill($(dceshape_svg));transitionTl=new TimelineMax();transitionTlpos=new TimelineMax();$('.madxartwork-element[data-id='+id_scope+']').on('mouseenter','svg',mouseenterFn);$('.madxartwork-element[data-id='+id_scope+']').on('mouseleave','svg',mouseleaveFn);$('.madxartwork-element[data-id='+id_scope+']').on('touchstart','svg',mouseenterFn);$('.madxartwork-element[data-id='+id_scope+']').on('touchend','svg',mouseleaveFn)}else if(elementSettings.svg_trigger=='scroll'){if(one_by_one){if(transitionTl)transitionTl.kill($(dceshape));if(transitionTlpos)transitionTlpos.kill($(dceshape_svg));transitionTl=new TimelineMax();transitionTlpos=new TimelineMax()}else{if(playpause_control=='paused'){ferma()}else{createTween()}
if(madxartworkFrontend.isEditMode()&&contentElemsTotal>1)playShapeEl()}
active_scrollAnalysi('#dce-svg-'+id_scope)}},100)};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-svgmorphing.default',WidgetElements_SvgMorphHandler)})})(jQuery)
...
photoSwipeContent();initPhotoSwipeFromDOM('.dynamic_acfgallery.is-lightbox.photoswipe, .dynamic_gallery.is-lightbox.photoswipe')}};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-acfgallery.default',WidgetDyncontel_ACFGalleryHandler)});var photoSwipeContent=function(){$('body').append('<div class="pswp" tabindex="-1" role="dialog" aria-hidden="true"><div class="pswp__bg"></div><div class="pswp__scroll-wrap"><div class="pswp__container"><div class="pswp__item"></div><div class="pswp__item"></div><div class="pswp__item"></div></div><div class="pswp__ui pswp__ui--hidden"><div class="pswp__top-bar"><div class="pswp__counter"></div><button class="pswp__button pswp__button--close" title="Close (Esc)"></button><button class="pswp__button pswp__button--share" title="Share"></button><button class="pswp__button pswp__button--fs" title="Toggle fullscreen"></button><button class="pswp__button pswp__button--zoom" title="Zoom in/out"></button><div class="pswp__preloader"><div class="pswp__preloader__icn"><div class="pswp__preloader__cut"><div class="pswp__preloader__donut"></div></div></div></div></div><div class="pswp__share-modal pswp__share-modal--hidden pswp__single-tap"><div class="pswp__share-tooltip"></div></div><button class="pswp__button pswp__button--arrow--left" title="Previous (arrow left)"></button><button class="pswp__button pswp__button--arrow--right" title="Next (arrow right)"></button><div class="pswp__caption"><div class="pswp__caption__center"></div></div></div></div></div>')}})(jQuery)
/*elements-acfposts.min.js*/
;var isAdminBar=!1,isEditMode=!1;(function($){var WidgetElementsPostsDCEHandler=function($scope,$){var infScroll=null;var elementSettings=get_Dyncontel_ElementSettings($scope),id_scope=$scope.attr('data-id'),madxartworkElement='.madxartwork-element-'+id_scope,is_history=Boolean(elementSettings.infiniteScroll_enable_history)?'replace':!1
$block_acfposts='.acfposts-grid',$objBlock_acfposts=$scope.find($block_acfposts);var id_post=$scope.closest('.madxartwork').attr('data-post-id');if($objBlock_acfposts.data('style')=='swiper'||$objBlock_acfposts.data('style')=='carousel'){if(elementSettings.masking_enable){$objBlock_acfposts.closest('.madxartwork-section').css('overflow','hidden')}}
...
$objBlock_acfposts.slick(slickOptions)}else if($($scope).find($block_acfposts).data('style')=='swiper'){var elementSettings=get_Dyncontel_ElementSettings($scope);var elementSwiper=$scope.find('.swiper-container')[0];var id_scope=$scope.attr('data-id');var centroDiapo=!1;var cicloInfinito=!1;var slideInitNum=0;var slidesPerView=Number(elementSettings.slidesPerView);var slideNum=$scope.find('.dce-post-item').length;centerDiapo=Boolean(elementSettings.centeredSlides);cicloInfinito=Boolean(elementSettings.loop);var madxartworkBreakpoints=madxartworkFrontend.config.breakpoints;var spaceBetween=0;if(elementSettings.spaceBetween){spaceBetween=elementSettings.spaceBetween}
var swiperOptions={direction:'horizontal',initialSlide:slideInitNum,speed:Number(elementSettings.speed_slider)||300,autoHeight:Boolean(elementSettings.autoHeight),roundLengths:Boolean(elementSettings.roundLengths),effect:elementSettings.effects||'slide',slidesPerView:slidesPerView||'auto',slidesPerGroup:Number(elementSettings.slidesPerGroup)||1,spaceBetween:spaceBetween,slidesOffsetBefore:0,slidesOffsetAfter:0,slidesPerColumn:Number(elementSettings.slidesColumn)||1,slidesPerColumnFill:'row',centerInsufficientSlides:!0,watchOverflow:!0,centeredSlides:centroDiapo,grabCursor:Boolean(elementSettings.grabCursor),freeMode:Boolean(elementSettings.freeMode),freeModeMomentum:Boolean(elementSettings.freeModeMomentum),freeModeMomentumRatio:Number(elementSettings.freeModeMomentumRatio)||1,freeModeMomentumVelocityRatio:Number(elementSettings.freeModeMomentumVelocityRatio)||1,freeModeMomentumBounce:Boolean(elementSettings.freeModeMomentumBounce),freeModeMomentumBounceRatio:Number(elementSettings.speed)||1,freeModeMinimumVelocity:Number(elementSettings.speed)||0.02,freeModeSticky:Boolean(elementSettings.freeModeSticky),loop:cicloInfinito,navigation:{nextEl:id_post?'.dce-madxartwork-post-'+id_post+' .madxartwork-element-'+id_scope+' .next-'+id_scope:'.next-'+id_scope,prevEl:id_post?'.dce-madxartwork-post-'+id_post+' .madxartwork-element-'+id_scope+' .prev-'+id_scope:'.prev-'+id_scope,},pagination:{el:id_post?'.dce-madxartwork-post-'+id_post+' .madxartwork-element-'+id_scope+' .pagination-'+id_scope:'.pagination-'+id_scope,clickable:!0,type:String(elementSettings.pagination_type)||'bullets',dynamicBullets:!0,renderFraction:function(currentClass,totalClass){return'<span class="'+currentClass+'"></span>'+'<span class="separator">'+String(elementSettings.fraction_separator)+'</span>'+'<span class="'+totalClass+'"></span>'},},mousewheel:Boolean(elementSettings.mousewheelControl),keyboard:{enabled:Boolean(elementSettings.keyboardControl),},on:{init:function(){$('body').attr('data-carousel-'+id_scope,this.realIndex)},slideChange:function(e){$('body').attr('data-carousel-'+id_scope,this.realIndex)},}};if(elementSettings.useAutoplay){swiperOptions=$.extend(swiperOptions,{autoplay:!0});var autoplayDelay=Number(elementSettings.autoplay);if(!autoplayDelay){autoplayDelay=3000}else{autoplayDelay=Number(elementSettings.autoplay)}
swiperOptions=$.extend(swiperOptions,{autoplay:{delay:autoplayDelay,disableOnInteraction:Boolean(elementSettings.autoplayDisableOnInteraction),stopOnLastSlide:Boolean(elementSettings.autoplayStopOnLast)}})}
var responsivePoints=swiperOptions.breakpoints={};responsivePoints[madxartworkBreakpoints.lg]={slidesPerView:Number(elementSettings.slidesPerView)||'auto',slidesPerGroup:Number(elementSettings.slidesPerGroup)||1,spaceBetween:Number(elementSettings.spaceBetween)||0,slidesPerColumn:Number(elementSettings.slidesColumn)||1,};responsivePoints[madxartworkBreakpoints.md]={slidesPerView:Number(elementSettings.slidesPerView_tablet)||Number(elementSettings.slidesPerView)||'auto',slidesPerGroup:Number(elementSettings.slidesPerGroup_tablet)||Number(elementSettings.slidesPerGroup)||1,spaceBetween:Number(elementSettings.spaceBetween_tablet)||0,slidesPerColumn:Number(elementSettings.slidesColumn_tablet)||Number(elementSettings.slidesColumn)||1,};responsivePoints[madxartworkBreakpoints.xs]={slidesPerView:Number(elementSettings.slidesPerView_mobile)||Number(elementSettings.slidesPerView_tablet)||Number(elementSettings.slidesPerView)||'auto',slidesPerGroup:Number(elementSettings.slidesPerGroup_mobile)||Number(elementSettings.slidesPerGroup_tablet)||Number(elementSettings.slidesPerGroup)||1,spaceBetween:Number(elementSettings.spaceBetween_mobile)||0,slidesPerColumn:Number(elementSettings.slidesColumn_mobile)||Number(elementSettings.slidesColumn_tablet)||Number(elementSettings.slidesColumn)||1,};swiperOptions=$.extend(swiperOptions,responsivePoints);var mySwiper=new Swiper(elementSwiper,swiperOptions);if(elementSettings.useAutoplay&&elementSettings.autoplayStopOnHover){$(elementSwiper).on({mouseenter:function(){mySwiper.autoplay.stop()},mouseleave:function(){mySwiper.autoplay.start()}})}}
if($objBlock_acfposts.data('style')=='grid'||$objBlock_acfposts.data('style')=='flexgrid'||$objBlock_acfposts.data('style')=='simple'){if(elementSettings.infiniteScroll_enable){if(jQuery(madxartworkElement+' .pagination__next').length){var infiniteScroll_options={path:madxartworkElement+' .pagination__next',history:is_history,append:madxartworkElement+' .dce-post-item',outlayer:iso,status:madxartworkElement+' .page-load-status',hideNav:madxartworkElement+'.pagination',scrollThreshold:'scroll'===elementSettings.infiniteScroll_trigger?!0:!1,loadOnScroll:'scroll'===elementSettings.infiniteScroll_trigger?!0:!1,onInit:function(){this.on('load',function(){})}}
if(elementSettings.infiniteScroll_trigger=='button'){infiniteScroll_options.button=madxartworkElement+' .view-more-button'}
infScroll=$objBlock_acfposts.infiniteScroll(infiniteScroll_options);var nElements=jQuery(madxartworkElement+' .dce-post-item:visible').length;$objBlock_acfposts.on('append.infiniteScroll',function(event,response,path,items){setTimeout(function(){var nElementsVisible=jQuery(madxartworkElement+' .dce-post-item:visible').length;if(nElementsVisible<=nElements){$objBlock_acfposts.infiniteScroll('loadNextPage')}},1000)})}}}
...
if($scope.find('.dce-hover-effect').length){$scope.find('.dce-post-item').each(function(i,el){$(el).on("mouseenter touchstart",function(){$(this).find('.dce-hover-effect-content').removeClass('dce-close').addClass('dce-open')});$(el).on("mouseleave touchend",function(){$(this).find('.dce-hover-effect-content').removeClass('dce-open').addClass('dce-close')})})}};$(window).on('madxartwork/frontend/init',function(){if(madxartworkFrontend.isEditMode()){isEditMode=!0}
if($('body').is('.admin-bar')){isAdminBar=!0}
madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-acfposts.default',WidgetElementsPostsDCEHandler)});if($('.wow').length){var wow=new WOW({boxClass:'wow',animateClass:'animated',offset:0,mobile:!0,live:!0,callback:function(box){},scrollContainer:null});wow.init()}})(jQuery)
/*elements-acfrepeater.min.js*/
;(function($){var WidgetDyncontel_ACFRepeaterHandler=function($scope,$){var elementSettings=get_Dyncontel_ElementSettings($scope);var $block_acfgallery='.dce-acf-repeater';if(elementSettings.dce_acf_repeater_format=='accordion'){$scope.find('.madxartwork-tab-title').on('click',function(){if(elementSettings.dce_acf_repeater_accordion_close){$scope.find('.madxartwork-active').not(this).each(function(){jQuery(this).toggleClass('madxartwork-active');jQuery(this).next().slideToggle().toggleClass('madxartwork-active')})}
jQuery(this).toggleClass('madxartwork-active');jQuery(this).next().slideToggle().toggleClass('madxartwork-active');return!1})}
if(elementSettings.dce_acf_repeater_format=='masonry'){var $grid_dce_repeater=$scope.find($block_acfgallery).masonry({itemSelector:'.dce-acf-repeater-item',});$grid_dce_repeater.imagesLoaded().progress(function(){$grid_dce_repeater.masonry('layout')})}else if(elementSettings.dce_acf_repeater_format=='justified'){$scope.find('.justified-grid').imagesLoaded().progress(function(){});$scope.find('.justified-grid').justifiedGallery({rowHeight:Number(elementSettings.justified_rowHeight.size)||170,maxRowHeight:-1,selector:'figure, div:not(.spinner)',imgSelector:'> img, > a > img, > div > a > img, > div > img',margins:Number(elementSettings.justified_margin.size)||0,lastRow:elementSettings.justified_lastRow})}else if(elementSettings.dce_acf_repeater_format=='slider_carousel'){var elementSwiper=$scope.find('.dce-acf-repeater-slider_carousel')[0];var id_scope=$scope.attr('data-id');var id_post=$scope.closest('.madxartwork').attr('data-post-id');var centroDiapo=!1;var cicloInfinito=!1;var slideInitNum=0;var slidesPerView=Number(elementSettings.slidesPerView);var slideNum=$scope.find('.repeater-item').length;centerDiapo=Boolean(elementSettings.centeredSlides);cicloInfinito=Boolean(elementSettings.loop);var madxartworkBreakpoints=madxartworkFrontend.config.breakpoints;var swiperOptions={direction:'horizontal',initialSlide:slideInitNum,speed:Number(elementSettings.speed_slider)||300,autoHeight:Boolean(elementSettings.autoHeight),roundLengths:Boolean(elementSettings.roundLengths),effect:elementSettings.effects||'slide',slidesPerView:slidesPerView||'auto',slidesPerGroup:Number(elementSettings.slidesPerGroup)||1,spaceBetween:Number(elementSettings.spaceBetween)||0,slidesOffsetBefore:0,slidesOffsetAfter:0,slidesPerColumn:Number(elementSettings.slidesColumn)||1,slidesPerColumnFill:'row',centerInsufficientSlides:!0,watchOverflow:!0,centeredSlides:centroDiapo,grabCursor:Boolean(elementSettings.grabCursor),freeMode:Boolean(elementSettings.freeMode),freeModeMomentum:Boolean(elementSettings.freeModeMomentum),freeModeMomentumRatio:Number(elementSettings.freeModeMomentumRatio)||1,freeModeMomentumVelocityRatio:Number(elementSettings.freeModeMomentumVelocityRatio)||1,freeModeMomentumBounce:Boolean(elementSettings.freeModeMomentumBounce),freeModeMomentumBounceRatio:Number(elementSettings.speed)||1,freeModeMinimumVelocity:Number(elementSettings.speed)||0.02,freeModeSticky:Boolean(elementSettings.freeModeSticky),loop:cicloInfinito,navigation:{nextEl:id_post?'.dce-madxartwork-post-'+id_post+' .madxartwork-element-'+id_scope+' .next-'+id_scope:'.next-'+id_scope,prevEl:id_post?'.dce-madxartwork-post-'+id_post+' .madxartwork-element-'+id_scope+' .prev-'+id_scope:'.prev-'+id_scope,},pagination:{el:id_post?'.dce-madxartwork-post-'+id_post+' .madxartwork-element-'+id_scope+' .pagination-'+id_scope:'.pagination-'+id_scope,clickable:!0,type:String(elementSettings.pagination_type)||'bullets',dynamicBullets:!0,renderFraction:function(currentClass,totalClass){return'<span class="'+currentClass+'"></span>'+'<span class="separator">'+String(elementSettings.fraction_separator)+'</span>'+'<span class="'+totalClass+'"></span>'},},mousewheel:Boolean(elementSettings.mousewheelControl),keyboard:{enabled:Boolean(elementSettings.keyboardControl),},on:{init:function(){$('body').attr('data-carousel-'+id_scope,this.realIndex)},slideChange:function(e){$('body').attr('data-carousel-'+id_scope,this.realIndex)},}};if(elementSettings.useAutoplay){swiperOptions=$.extend(swiperOptions,{autoplay:!0});var autoplayDelay=Number(elementSettings.autoplay);if(!autoplayDelay){autoplayDelay=3000}else{autoplayDelay=Number(elementSettings.autoplay)}
swiperOptions=$.extend(swiperOptions,{autoplay:{delay:autoplayDelay,disableOnInteraction:Boolean(elementSettings.autoplayDisableOnInteraction),stopOnLastSlide:Boolean(elementSettings.autoplayStopOnLast)}})}
...
responsivePoints[madxartworkBreakpoints.md]={slidesPerView:Number(elementSettings.slidesPerView_tablet)||Number(elementSettings.slidesPerView)||'auto',slidesPerGroup:Number(elementSettings.slidesPerGroup_tablet)||Number(elementSettings.slidesPerGroup)||1,spaceBetween:Number(spaceBetween_tablet)||0,slidesPerColumn:Number(elementSettings.slidesColumn_tablet)||Number(elementSettings.slidesColumn)||1,};var spaceBetween_mobile=spaceBetween_tablet;if(elementSettings.spaceBetween_mobile){spaceBetween_mobile=elementSettings.spaceBetween_mobile}
responsivePoints[madxartworkBreakpoints.xs]={slidesPerView:Number(elementSettings.slidesPerView_mobile)||Number(elementSettings.slidesPerView_tablet)||Number(elementSettings.slidesPerView)||'auto',slidesPerGroup:Number(elementSettings.slidesPerGroup_mobile)||Number(elementSettings.slidesPerGroup_tablet)||Number(elementSettings.slidesPerGroup)||1,spaceBetween:Number(spaceBetween_mobile)||0,slidesPerColumn:Number(elementSettings.slidesColumn_mobile)||Number(elementSettings.slidesColumn_tablet)||Number(elementSettings.slidesColumn)||1,};swiperOptions=$.extend(swiperOptions,responsivePoints);var mySwiper=new Swiper(elementSwiper,swiperOptions);if(elementSettings.useAutoplay&&elementSettings.autoplayStopOnHover){$(elementSwiper).on({mouseenter:function(){mySwiper.autoplay.stop()},mouseleave:function(){mySwiper.autoplay.start()}})}}
...
gallery=new PhotoSwipe(pswpElement,PhotoSwipeUI_Default,items,options);gallery.init()};var galleryElements=document.querySelectorAll(gallerySelector);for(var i=0,l=galleryElements.length;i<l;i++){galleryElements[i].setAttribute('data-pswp-uid',i+1);galleryElements[i].onclick=onThumbnailsClick}
var hashData=photoswipeParseHash();if(hashData.pid&&hashData.gid){openPhotoSwipe(hashData.pid,galleryElements[hashData.gid-1],!0,!0)}};if($scope.find('.dynamic_acfgallery.is-lightbox.photoswipe, .dynamic_gallery.is-lightbox.photoswipe').length>0){if($('body').find('.pswp').length<1)
photoSwipeContent();initPhotoSwipeFromDOM('.dynamic_acfgallery.is-lightbox.photoswipe, .dynamic_gallery.is-lightbox.photoswipe')}};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-acf-repeater.default',WidgetDyncontel_ACFRepeaterHandler)});var photoSwipeContent=function(){$('body').append('<div class="pswp" tabindex="-1" role="dialog" aria-hidden="true"><div class="pswp__bg"></div><div class="pswp__scroll-wrap"><div class="pswp__container"><div class="pswp__item"></div><div class="pswp__item"></div><div class="pswp__item"></div></div><div class="pswp__ui pswp__ui--hidden"><div class="pswp__top-bar"><div class="pswp__counter"></div><button class="pswp__button pswp__button--close" title="Close (Esc)"></button><button class="pswp__button pswp__button--share" title="Share"></button><button class="pswp__button pswp__button--fs" title="Toggle fullscreen"></button><button class="pswp__button pswp__button--zoom" title="Zoom in/out"></button><div class="pswp__preloader"><div class="pswp__preloader__icn"><div class="pswp__preloader__cut"><div class="pswp__preloader__donut"></div></div></div></div></div><div class="pswp__share-modal pswp__share-modal--hidden pswp__single-tap"><div class="pswp__share-tooltip"></div></div><button class="pswp__button pswp__button--arrow--left" title="Previous (arrow left)"></button><button class="pswp__button pswp__button--arrow--right" title="Next (arrow right)"></button><div class="pswp__caption"><div class="pswp__caption__center"></div></div></div></div></div>')}})(jQuery)
/*elements-acfslider.min.js*/
;(function($){var WidgetElements_ACFSliderHandler=function($scope,$){var elementSettings=get_Dyncontel_ElementSettings($scope);var elementSwiper=$scope.find('.swiper-container')[0];var id_scope=$scope.attr('data-id');var id_post=$scope.closest('.madxartwork').attr('data-post-id');var interleaveOffset=-.5;var interleaveEffect={onProgress:function(swiper,progress){for(var i=0;i<swiper.slides.length;i++){var slide=swiper.slides[i];var translate,innerTranslate;progress=slide.progress;if(progress>0){translate=progress*swiper.width;innerTranslate=translate*interleaveOffset}else{innerTranslate=Math.abs(progress*swiper.width)*interleaveOffset;translate=0}
...
photoSwipeContent();initPhotoSwipeFromDOM('.dynamic_acfslider.is-lightbox.photoswipe')}};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-acfslider.default',WidgetElements_ACFSliderHandler)});var photoSwipeContent=function(){$('body').append('<div class="pswp" tabindex="-1" role="dialog" aria-hidden="true"><div class="pswp__bg"></div><div class="pswp__scroll-wrap"><div class="pswp__container"><div class="pswp__item"></div><div class="pswp__item"></div><div class="pswp__item"></div></div><div class="pswp__ui pswp__ui--hidden"><div class="pswp__top-bar"><div class="pswp__counter"></div><button class="pswp__button pswp__button--close" title="Close (Esc)"></button><button class="pswp__button pswp__button--share" title="Share"></button><button class="pswp__button pswp__button--fs" title="Toggle fullscreen"></button><button class="pswp__button pswp__button--zoom" title="Zoom in/out"></button><div class="pswp__preloader"><div class="pswp__preloader__icn"><div class="pswp__preloader__cut"><div class="pswp__preloader__donut"></div></div></div></div></div><div class="pswp__share-modal pswp__share-modal--hidden pswp__single-tap"><div class="pswp__share-tooltip"></div></div><button class="pswp__button pswp__button--arrow--left" title="Previous (arrow left)"></button><button class="pswp__button pswp__button--arrow--right" title="Next (arrow right)"></button><div class="pswp__caption"><div class="pswp__caption__center"></div></div></div></div></div>')}})(jQuery)
...
var changeAndSplittingText=function($i,$ii){target.empty().html(texts[$i]);target.removeClass('madxartwork-repeater-item-'+ids[$ii]).addClass('madxartwork-repeater-item-'+ids[$i]);split=new SplitText(target,{type:['chars','words','lines'],});switch(type){case 'chars':splitter=split.chars;break;case 'words':splitter=split.words;break;case 'lines':splitter=split.lines;break;default:break}
...
changeAndSplittingText(count,old_count);if(elementSettings.animatetext_trigger=='animation'){riproduci()}else if(elementSettings.animatetext_trigger=='rollover'){}else if(elementSettings.animatetext_trigger=='scroll'){active_scrollAnalysi(target)}};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-animateText.default',WidgetElements_AnimateTextHandler)})})(jQuery)
...
if($('.dg').length)$('.dg').empty();let sketch=new Sketch({content:contentDistortion[0],container:containerDistortion[0],debug:!1,duration:speedDistortion,uniforms:uniform_selected,fragment:fragment_selected})};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-imagesDistortion.default',WidgetElements_imagesDistortionHandler)})})(jQuery)
...
setWidth(){heightAadminBar=0;if($('body').is('.admin-bar')&&!madxartworkFrontend.isEditMode()){heightAadminBar=45}
...
setHeight(){heightAadminBar=0;if($('body').is('.admin-bar')&&!madxartworkFrontend.isEditMode()){heightAadminBar=45}
...
var is_inertiaScroll=!1;var directionScroll='vertical';var coefSpeed_inertiaScroll=0.05;var html=document.documentElement;var scroller={};const body=document.body;var main={};var mainWrap={};var skew_inertiaScroll=20;var bounce_inertiaScroll=0;let sx=0;let sy=0;let dx=sx;let dy=sy;var requestId;var init_Scrollify=function(){$('body').addClass('dce-scrollify dce-scrolling');if(settings_page.custom_class_section_sfy){$customClass=settings_page.custom_class_section_sfy}else{$customClass='madxartwork-section'}
$target_sections='.madxartwork-'+currentPostId;if(!$target_sections)
$target_sections='';sezioni=$target_sections+'.madxartwork > .madxartwork-inner > .madxartwork-section-wrap > .'+$customClass;wrapperSezioni=$($target_sections+'.madxartwork > .madxartwork-inner > .madxartwork-section-wrap');$($target_sections).addClass('scroll-direction-'+settings_page.directionScroll);$.scrollify({section:sezioni,sectionName:'id',interstitialSection:settings_page.interstitialSection,easing:"easeOutExpo",scrollSpeed:Number(settings_page.scrollSpeed.size)||1100,offset:Number(settings_page.offset.size)||0,scrollbars:Boolean(settings_page.scrollBars),setHeights:Boolean(settings_page.setHeights),overflowScroll:Boolean(settings_page.overflowScroll),updateHash:Boolean(settings_page.updateHash),touchScroll:Boolean(settings_page.touchScroll),before:function(i,panels){var ref=panels[i].attr("data-id");$(".dce-scrollify-pagination .nav__item--current").removeClass("nav__item--current");$(".dce-scrollify-pagination").find("a[href=\"#"+ref+"\"]").addClass("nav__item--current")},afterRender:function(){is_scrollify=!0;if(settings_page.enable_scrollify_nav||madxartworkFrontend.isEditMode()){var scrollify_pagination='';createNavigation(settings_page.snapscroll_nav_style);$("body").on("click",".dce-scrollify-pagination a",function(){$.scrollify.move($(this).attr("href"));return!1});if(!Boolean(settings_page.enable_scrollify_nav)){handleScrollify_enablenavigation('')}
...
var init_ScrollEffects=function(){$('body').addClass('dce-pageScroll dce-scrolling');if(settings_page.custom_class_section){$customClass=settings_page.custom_class_section}else{$customClass='madxartwork-section'}
$target_sections='.madxartwork-'+currentPostId;if(!$target_sections)
$target_sections='';sezioni=$target_sections+'.madxartwork > .madxartwork-inner > .madxartwork-section-wrap > .'+$customClass;sectionsAvailable=$(sezioni);wrapperSezioni=$($target_sections+'.madxartwork > .madxartwork-inner > .madxartwork-section-wrap');$($target_sections).addClass('scroll-direction-'+settings_page.directionScroll);animationType=settings_page.animation_effects||['spin'];var animationType_string=[];if(animationType.length)
...
requestId=window.requestAnimationFrame(updateLax)
is_scrollEffects=!0}
var init_InertiaScroll=function(){if(settings_page.custom_class_section){$customClass=settings_page.custom_class_section}else{$customClass='madxartwork-section'}
...
directionScroll=settings_page.directionScroll||'vertical';$target_sections='.madxartwork-'+currentPostId;if(!$target_sections)
$target_sections='';sezioni=$target_sections+'.madxartwork > .madxartwork-inner > .madxartwork-section-wrap > .'+$customClass;sectionsAvailable=$(sezioni);wrapperSezioni=$($target_sections+'.madxartwork > .madxartwork-inner > .madxartwork-section-wrap');if($('.madxartwork-template-canvas').length){main=document.querySelector($target_sections);mainWrap=document.querySelector($target_sections+'.madxartwork > .madxartwork-inner > .madxartwork-section-wrap')}else{if(settings_page.automatic_wrapper){if(!$('#outer-wrap').length)
...
setTimeout(function(){if(settings_page.enable_inertiaScroll)
init_InertiaScroll()},100)}else{removeInertiaScroll()}}
$(window).on('madxartwork/frontend/init',function(){});$(document).on('ready',function(){if(typeof madxartworkFrontendConfig.settings.page!=='undefined'){settings_page=madxartworkFrontendConfig.settings.page;currentPostId=madxartworkFrontendConfig.post.id;is_enable_dceScrolling=settings_page.enable_dceScrolling;is_enable_scrollify=settings_page.enable_scrollify;is_enable_scrollEffects=settings_page.enable_scrollEffects;is_enable_inertiaScroll=settings_page.enable_inertiaScroll;var responsive_scrollEffects=settings_page.responsive_scrollEffects;var responsive_snapScroll=settings_page.responsive_snapScroll;var responsive_inertiaScroll=settings_page.responsive_inertiaScroll;var deviceMode=$('body').attr('data-madxartwork-device-mode');if(is_enable_scrollEffects&&is_enable_dceScrolling&&$.inArray(deviceMode,responsive_scrollEffects)>=0){init_ScrollEffects()}
...
if(madxartworkFrontend.isEditMode()){if(madxartwork){settings_page=madxartwork.settings.page.model.attributes;madxartwork.settings.page.addChangeCallback('enable_dceScrolling',handlescroll_viewport);madxartwork.settings.page.addChangeCallback('enable_scrollify',handleScrollify);madxartwork.settings.page.addChangeCallback('scrollSpeed',handleScrollify_speed);madxartwork.settings.page.addChangeCallback('offset',handleScrollify_offset);madxartwork.settings.page.addChangeCallback('ease_scrollify',handleScrollify_ease);madxartwork.settings.page.addChangeCallback('setHeights',handleScrollify_setHeights);madxartwork.settings.page.addChangeCallback('overflowScroll',handleScrollify_overflowScroll);madxartwork.settings.page.addChangeCallback('updateHash',handleScrollify_updateHash);madxartwork.settings.page.addChangeCallback('scrollBars',handleScrollify_scrollBars);madxartwork.settings.page.addChangeCallback('touchScroll',handleScrollify_touchScroll);madxartwork.settings.page.addChangeCallback('enable_scrollify_nav',handleScrollify_enablenavigation);madxartwork.settings.page.addChangeCallback('snapscroll_nav_style',handleScrollify_navstyle);madxartwork.settings.page.addChangeCallback('snapscroll_nav_title_style',handleScrollify_titlestyle);madxartwork.settings.page.addChangeCallback('enable_scrollEffects',handleScrollEffects);madxartwork.settings.page.addChangeCallback('animation_effects',handleScrollEffects_animations);madxartwork.settings.page.addChangeCallback('remove_first_scrollEffects',handleScrollEffects_removefirst);madxartwork.settings.page.addChangeCallback('enable_inertiaScroll',handleInertiaScroll);madxartwork.settings.page.addChangeCallback('directionScroll',handleInertiaScroll_direction);madxartwork.settings.page.addChangeCallback('coefSpeed_inertiaScroll',handleInertiaScroll);madxartwork.settings.page.addChangeCallback('skew_inertiaScroll',handleInertiaScroll);madxartwork.settings.page.addChangeCallback('bounce_inertiaScroll',handleInertiaScroll)}}}})})(jQuery)
...
function checkTimelineScroll(){verticalTimelinesArray.forEach(function(timeline){timeline.showBlocks()});scrolling=!1}};$(window).on('madxartwork/frontend/init',function(){if(madxartworkFrontend.isEditMode()){isEditMode=!0}
if($('body').is('.admin-bar')){isAdminBar=!0}
madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-dynamicusers.default',WidgetElementsDynamicUsersDCEHandler)})})(jQuery)
...
function closeModal(){var section=$scope.find('.dce-modalwindow-section.modal-is-visible');section.removeClass('modal-is-visible').one('webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend',function(){});animateLayer(section.find('.cd-modal-bg'),1,!1)}};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-modalwindow.default',WidgetElements_ModalWindowHandler)})})(jQuery)
/*elements-parallax.min.js*/
;(function($){var WidgetElements_ParallaxHandler=function($scope,$){var scene=$scope.find('#scene');var parallax=new Parallax(scene[0])};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-parallax.default',WidgetElements_ParallaxHandler)})})(jQuery)
...
if(!is_animate)
setTimeout(function(){if(!madxartworkFrontend.isEditMode()){is_animate=!0;$('body').removeClass('modal-close-'+id_modal).removeClass('modal-close-'+id_modal_scope);$('body').addClass('modal-open-'+id_modal).addClass('modal-open-'+id_modal_scope).addClass('dce-modal-open');$('html').addClass('dce-modal-open');$('#'+id_modal+' .modal-dialog').one('webkitAnimationEnd oanimationend msAnimationEnd animationend',function(el){is_animate=!1})}
...
$('body').removeClass('modal-open-'+id_modal).removeClass('modal-open-'+id_modal_scope);$('body').addClass('modal-close-'+id_modal).addClass('modal-close-'+id_modal_scope);$('#'+id_modal+'-background').one('webkitAnimationEnd oanimationend msAnimationEnd animationend',function(el){console.log('hide bg '+id_modal);$('#'+id_modal+'-background').hide();$(el.currentTarget).off('webkitAnimationEnd oanimationend msAnimationEnd animationend')});$('#'+id_modal+' .modal-dialog').one('webkitAnimationEnd oanimationend msAnimationEnd animationend',function(el){console.log('hide '+id_modal);$('#'+id_modal).hide();setTimeout(function(){if(!madxartworkFrontend.isEditMode()){$('body').removeClass('modal-close-'+id_modal).removeClass('modal-close-'+id_modal_scope).removeClass('dce-modal-open');$('html').removeClass('dce-modal-open');$(el.currentTarget).off('webkitAnimationEnd oanimationend msAnimationEnd animationend')}
...
var modal=$scope.find('.dce-popup-container-'+id_scope);function push_actions(){if(!madxartworkFrontend.isEditMode()){$(modal).prependTo("body")}}
...
$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/dyncontel-popup.default',WidgetElementsPopupHandler)})})(jQuery)
...
initRellax()}})
var initRellax=function(){if(elementSettings.enabled_rellax){currentDevice=madxartworkFrontend.getCurrentDeviceMode();var setting_speed='speed_rellax';var value_speed=0;if(currentDevice!='desktop'){setting_speed='speed_rellax_'+currentDevice}
if(eval('elementSettings.'+setting_speed+'.size'))
value_speed=eval('elementSettings.'+setting_speed+'.size');var rellaxId='#rellax-'+$scope.data('id');if($(rellaxId).length)
rellax=new Rellax(rellaxId,{speed:value_speed,});isRellax=!0}};initRellax()};$(window).on('madxartwork/frontend/init',function(){madxartworkFrontend.hooks.addAction('frontend/element_ready/global',WidgetElements_RellaxHandlerFront)})})(jQuery)
